...
namespace Boardgame.Api.Common.Errors;

public class BoardgameProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public BoardgameProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
